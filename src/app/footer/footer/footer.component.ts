...
import { loadFooterLinks } from 'src/store/footer/actions';
...
export class FooterComponent {
  ...
  constructor(private store: Store<FooterState>, private footerService: FooterService) {
    this.store.dispatch(loadFooterLinks());
